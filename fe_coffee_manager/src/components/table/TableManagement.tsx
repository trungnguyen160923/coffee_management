...
export default function TableManagement({ onEditTable, onDeleteTable, refreshTrigger }: TableManagementProps) {
    const { user } = useAuth();
    ...
    useEffect(() => {
        ...
        loadTables();
    }, [branchId, refreshTrigger]); // Add refreshTrigger to dependencies
                ...
                <div className="overflow-x-auto">
                    <table className="w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                <th className="w-1/4 px-12 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Label</th>
                                <th className="w-1/6 px-8 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Capacity</th>
                                <th className="w-1/6 px-8 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                                <th className="w-1/3 px-12 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Actions</th>
                            </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200">
                            {paginatedTables.map((table) => (
                                <tr key={table.tableId} className="hover:bg-gray-50">
                                    <td className="w-1/4 px-12 py-5 whitespace-nowrap text-sm font-medium text-gray-900">
                                        {table.label}
                                    </td>
                                    <td className="w-1/6 px-8 py-5 whitespace-nowrap text-sm text-gray-500 text-center">
                                    ...
                                    <td className="w-1/3 px-12 py-5 whitespace-nowrap text-sm text-gray-500">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    {onEditTable && (
                                                        <button
                                                            ...
                                                            className="p-3 rounded-lg hover:bg-blue-50 text-blue-600 transition-colors"
                                                            title="Edit table"
                                                        >
