                ...
                <div className="overflow-x-auto">
                    <table className="w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                <th className="w-1/3 px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Label</th>
                                <th className="w-1/4 px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Capacity</th>
                                <th className="w-1/3 px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                            </tr>
                        </thead>
                            ...
                            {paginatedTables.map((table) => (
                                <>
                                    <tr key={table.tableId} className="hover:bg-gray-50">
                                        <td className="w-1/3 px-6 py-5 whitespace-nowrap text-sm font-medium text-gray-900">
                                            {table.label}
                                        </td>
                                        <td className="w-1/4 px-6 py-5 whitespace-nowrap text-sm text-gray-500 text-center">
                                            {table.capacity} people
                                        </td>
                                        <td className="w-1/3 px-6 py-5 whitespace-nowrap text-sm text-gray-500 text-center">
                                    ...
                                    <tr className="bg-gray-50">
                                        <td colSpan={3} className="px-6 py-3">
                                            <div className="flex items-center justify-center gap-4">
                                                <span className="text-sm font-medium text-gray-700 mr-4">Change Status:</span>
                                                <select
                                                    value={table.status}
